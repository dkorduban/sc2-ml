...
#
# This modification dumps all observations in a set of replays
# and is compatible with dasc2 filter format.

"""Dump out all observations set of replays."""
...
flags.DEFINE_string("filter", None, "Path to a dasc2 filter file.")
flags.DEFINE_string("save_dir", None, "Path to a directory with extracted observations.")
